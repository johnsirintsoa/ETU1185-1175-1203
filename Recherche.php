                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Resultat de la recherche</h2>
                                ...
                                <div class="product foo">
                                    <div class="product__inner">
                                        <div class="pro__thumb">
                                            <a href="#">
                                                <img src=<?php echo $search[$i]['image'];?> alt="product images">
                                            </a>
                                        </div>
                                        <div class="product__hover__info">
                                            <ul class="product__action">
                                                    <li><a data-toggle="modal" data-target="#productModal" title="Quick View" class="quick-view modal-view detail-link" href="#"><span class="ti-plus"></span></a></li>
                                                    <li><a title="Add TO Cart" href="cart.php?produit='<?php echo $search[$i]['idProduit']?>'><span class="ti-shopping-cart"></span></a></li>
                                                    <li><a title="Wishlist" href="wishlist.php"><span class="ti-heart"></span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product__details">
                                        <h2><a href="product-details.php"><?php echo $search[$i]['nom'];?></a></h2>
                                        <ul class="product__price">                                    
                                            <li class="new__price"><?php echo $search[$i]['prix'];?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
